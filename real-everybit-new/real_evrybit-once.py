...
##    print clear
    ...
    print " Blood Pressure [normal diastolic < 75, systolic < 140]: ", net.activate(pout)
...
##    go=119.845664762
    ...
    print " Glucose level[before eating 70-90 after eating < 130  : ", (90+uniform(0,50))#+str(output)+' '
